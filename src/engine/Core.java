            ...
            switch (returnCode) {
                ...
                case 3:
                    ...
                    do {
                        ...
                        currentScreen = new GameScreen(gameState,
                                gameSettings.get(gameState.getLevel() - 1),
                                bonusLife, width, height, FPS, true);
                        LOGGER.info("Starting " + WIDTH + "x" + HEIGHT + " 2-player game screen at " + FPS + " fps.");
                        frame.setScreen(currentScreen);
                        LOGGER.info("Closing 2-player game screen.");
                    ...
                    LOGGER.info("Starting " + WIDTH + "x" + HEIGHT + " score screen at " + FPS + " fps, with a score of "
                            ...
                            + gameState.getBulletsShot() + " bullets shot and " + gameState.getShipsDestroyed() + " ships destroyed.");
                    currentScreen = new ScoreScreen(width, height, FPS, gameState);
                    returnCode = frame.setScreen(currentScreen);
                    LOGGER.info("Closing score screen.");
                    break;
